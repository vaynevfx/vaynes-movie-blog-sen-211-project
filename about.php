				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					<div class="blog-grid-top">
						...
						<div class="blog_info_left_grid">
							<a href="single.html">
								<img src="images/b5.jfif" class="img-fluid" alt="">
							</a>
						</div>
						<h3>
							Kamal Nuhu Amanabo, Head Engineer
						</h3>
						<p>A freelance programmer working remotely from nigeria..</p>
					</div>
				</div>
				<!--//left-->
				<!--right-->
